...
class PIConvergenceCheck
{
    ...
    public:
        PIConvergenceCheck( unsigned int total_pi = 10, unsigned int points_start = 1'000, unsigned int points_multiplier = 10,
                            unsigned int max_points = 10'000'000, double eps = 0.0001 ):
        ...
        void set_max_points( unsigned int max_points )
        {
