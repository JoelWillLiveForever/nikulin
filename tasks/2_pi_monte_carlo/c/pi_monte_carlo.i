...
# 13 "pi_monte_carlo.c"
    ...
    while (curr_point < 2500000000)
    {
        double x = (double) rand() / (double) 
# 19 "pi_monte_carlo.c" 3 4
                                             2147483647
# 19 "pi_monte_carlo.c"
                                                     ;
        double y = (double) rand() / (double) 
# 20 "pi_monte_carlo.c" 3 4
                                             2147483647
# 20 "pi_monte_carlo.c"
                                                     ;
    ...
    double pi = 4.0 * (((double) good_points) / 2500000000);
    printf("PI = %f\n", pi);
