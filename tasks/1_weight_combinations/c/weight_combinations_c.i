# 0 "weight_combinations.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "weight_combinations.c"
...
# 7 "weight_combinations.c" 2




# 10 "weight_combinations.c"
...
int search_all_ways_recursive(int V, int sub, int sub_remains[], int sub_hash, int sub_hashes_remains[], int remains_size)
{
    ...
    {
        int next_sub_remains[next_remains_size];
        int next_sub_hashes_remains[next_remains_size];
...
{
    setlocale(
# 63 "weight_combinations.c" 3 4
             6
# 63 "weight_combinations.c"
                   , "Rus");

    int weights[] = {100, 200, 300, 500, 1000, 1200, 1400, 1500, 2000, 3000};
    int hash_codes[] = {55, 23, 421, 90, 10, 4, -8, 92, 67, 111};
    ...
    for (int sub_index = 0; sub_index < weights_amount; sub_index++)
    {
        ...
        int sub_hash = hash_codes[sub_index];
